...
function chengeBackground(){
  if (getHours > 7 && getHours < 16){
    ...
    //impostail background del colore in night e color light
...
function showWeather(data){
  result.classList.remove('sole','nuvoloso')
  ...
  document.querySelector('#temperature').innerText = `gradi: ${data.main.temp}°`
  ...
  showDate.innerText = 'ora: ' + totalDate
}
